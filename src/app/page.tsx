    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex items-center justify-center gap-4 flex-wrap">
            <a
              ...
              className="inline-flex items-center gap-2 bg-indigo-600 text-white font-semibold px-7 py-3.5 rounded-xl hover:bg-indigo-700 transition-colors text-base"
            >
              Get started for your school <ArrowRight className="w-4 h-4" />
            </a>
            <Link
              href={`https://demo.${rootDomain}/submit`}
              className="inline-flex items-center gap-2 border border-slate-300 text-slate-700 font-semibold px-7 py-3.5 rounded-xl hover:border-slate-400 hover:bg-slate-50 transition-colors text-base"
            >
              See a live demo
            </Link>
          </div>
      ...
      <section className="py-20 bg-slate-50 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-slate-500 mb-12">One plan. Everything included. No per-seat fees.</p>
          <div className="bg-white rounded-2xl border border-slate-200 p-10 shadow-sm">
            <div className="text-5xl font-extrabold text-slate-900 mb-2">
              $49<span className="text-xl font-normal text-slate-400">/month</span>
            </div>
            <p className="text-slate-500 mb-8">Per school. Unlimited staff.</p>
      ...
      <section className="py-20 px-6 bg-indigo-600">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Ready to simplify your mornings?</h2>
          <p className="text-indigo-200 mb-8">
            Register your school today. We review and approve accounts within 24 hours.
          </p>
          <a
            href="mailto:support@outofshift.com?subject=StaffOut%20school%20signup&body=School%20name%3A%0AContact%20name%3A%0AContact%20email%3A"
            className="inline-flex items-center gap-2 bg-white text-indigo-600 font-bold px-8 py-3.5 rounded-xl hover:bg-indigo-50 transition-colors"
          >
