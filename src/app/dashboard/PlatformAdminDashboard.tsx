...
export default function PlatformAdminDashboard() {
  ...
  async function handleManage(org: Org) {
    ...
    window.location.assign(`${protocol}//${org.slug}.${ROOT_DOMAIN}/dashboard`)
  }
    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
        <div className="bg-red-50 border border-red-200 text-red-700 p-6 rounded-xl text-center max-w-sm">
          ...
          <p className="text-sm mt-1 text-red-600">Only the platform admin can access this page.</p>
        </div>
      </div>
    )
  }
        ...
        <div className="flex items-center justify-between mb-8 gap-3 flex-wrap">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-500 text-sm">Approve schools, manage subdomains, and support school admins.</p>
            </div>
          </div>
